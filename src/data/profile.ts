...
import {
  ...
  SiPython,
  SiSqlite,
  /* Java icon not available in react-icons/si */
  SiGo,
  SiNodedotjs,
  SiExpress,
  SiNestjs,
...
import { FaJava, FaProjectDiagram, FaCogs } from 'react-icons/fa'
import  FastifyIcon  from '../icons/FastifyIcon'

export const SKILLS: { name: string; Icon?: React.ComponentType<{ className?: string }> }[] = [
  { name: 'C', Icon: SiC },
  ...
  { name: 'REST APIs' },
  { name: 'gRPC', Icon: FaProjectDiagram },
